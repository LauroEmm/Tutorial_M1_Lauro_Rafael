...
var status = 1 #variável responsável para definir se o dragão está em movimento ou parado
var vscore = 0 #Pontuação do player
var x = 4.0 #Velocidade horizontal do dragão
var y = 3.0 #Gravidade atuada no dragão
